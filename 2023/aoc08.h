...
#define LPAREN (
#define RPAREN )
#define curry_finish(...) , ##__VA_ARGS__ RPAREN
#define curryI(fn, ...) fn LPAREN __VA_ARGS__ curry_finish
#define curry(...) curryI(__VA_ARGS__)
